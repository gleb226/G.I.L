    ...
    en: {
        ...
        pages: {
            main: {
                ...
                guestsChildrenSub: "0–17 years old",
                specifyChildrenAges: "Specify child ages",
            ...
            booking: {
                ...
                step1Desc: "Choose an apartment on the main page or in the catalog. Enter check-in and check-out dates to check availability.",
                step2Title: "Booking details",
                step2Desc: "Enter your name, phone number, and any special wishes. It takes less than a minute.",
                step3Title: "Prepayment",
                step3Desc: "To confirm the booking, a 50% prepayment of the total cost is required via the secure LiqPay system.",
                step4Title: "Check-in & Documents",
                step4Desc: "When checking in, you must have a passport or ID card. The remaining amount is paid upon arrival.",
                infoEyebrow: "Terms & Conditions",
                infoTitle: "How booking works",
                infoSubtitle: "A few simple steps for your comfortable stay.",
    ...
    uk: {
        ...
        pages: {
            main: {
                ...
                guestsTitle: "Гості та домашні улюбленці",
                guestsAdults: "Дорослі",
                guestsChildren: "Діти",
                guestsChildrenSub: "0–17 років",
                specifyChildrenAges: "Вкажіть вік дітей",
                guestsChildrenPlaceholder: "0",
                guestsPets: "З домашніми улюбленцями",
            ...
            booking: {
                ...
                step1Title: "Оберіть квартиру та дати",
                step1Desc: "Оберіть квартиру на головній сторінці або в каталозі. Вкажіть дати заїзду та виїзду, щоб перевірити доступність.",
                step2Title: "Заповніть форму",
                step2Desc: "Вкажіть своє ім'я, номер телефону та особливі побажання. Це займе менше хвилини.",
                step3Title: "Оплатіть передплату",
                step3Desc: "Для підтвердження бронювання необхідно внести 50% від загальної вартості через безпечну систему LiqPay.",
                step4Title: "Заїзд та документи",
                step4Desc: "Під час поселення необхідно мати при собі паспорт або ID-картку. Решта суми сплачується при заїзді.",
                infoEyebrow: "Правила та умови",
                infoTitle: "Як відбувається бронювання",
                infoSubtitle: "Кілька простих кроків для вашого комфортного перебування.",
